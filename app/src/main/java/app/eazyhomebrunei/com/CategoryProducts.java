...
public class CategoryProducts extends AppCompatActivity implements  categoryproductsadapter.CartItemClickListener{
...
//        catagory1=intent.getStringExtra("");
...
//        },5000);
    ...
    private void loadProducts() {
        final String URL_SUBCATAGORY=PATH+"ListCategoryProducts?CategoryId="+sub_cata+"&SubCategoryId="+id;
...
//
                    ...
                    ctadapter.setOnItemClickListener(CategoryProducts.this);
                    recyclerView3.setLayoutManager(new GridLayoutManager(CategoryProducts.this, 2));
