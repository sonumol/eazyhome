...
public class Singleproduct_imageAdapter extends PagerAdapter {
    private Context context;
    private LayoutInflater layoutInflater;
    private List<SliderUtils> slideimg;
    private ImageLoader imageLoader;

    public Singleproduct_imageAdapter(List<SliderUtils> sliderimg,Context context) {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
      ...
      //  imageLoader.get(utils.getSliderImageUrl(),ImageLoader.getImageListener(imageView,R.drawable.progressbar));
        Picasso with = Picasso.with(context);
        StringBuilder sb = new StringBuilder();
        sb.append(BaseURL.PRODUCT_IMG_PATH);
        sb.append(utils.getSliderImageUrl());
        with.load(sb.toString()).placeholder(context.getResources().getDrawable(R.drawable.ic_error_place_holder)).
                error(context.getResources().getDrawable(R.drawable.ic_error_place_holder))
                .into(imageView);
