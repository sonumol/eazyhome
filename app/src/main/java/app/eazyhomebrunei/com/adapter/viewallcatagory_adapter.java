...
public class viewallcatagory_adapter extends RecyclerView.Adapter<viewallcatagory_adapter.viewHolder> {
    ...
    public viewallcatagory_adapter(Context mcontext, List<Product> listitem) {
    ...
    @NonNull
    @Override
    public viewallcatagory_adapter.viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v= LayoutInflater.from(parent.getContext()).inflate(R.layout.catagory_adapter1,parent,false);
      mcontext=parent.getContext();

        return  new viewallcatagory_adapter.viewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull final viewallcatagory_adapter.viewHolder holder, int position) {
