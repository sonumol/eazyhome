...
public class subincategoryproducts extends AppCompatActivity implements vieallsubincategoryadapter.CartItemClickListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_subincategoryproducts);
...
//        },5000);
    ...
    private void loadProducts() {
        final String URL_SUBCATAGORY=PATH+"ListCategoryProducts?CategoryId="+id+"&SubCategoryId="+sub_cata+"&SubinCategory="+subincat;
...
//
                    ...
                    ctadapter.setOnItemClickListener(subincategoryproducts.this);
                    recyclerView3.setLayoutManager(new GridLayoutManager(subincategoryproducts.this, 2));
