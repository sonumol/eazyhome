...
import app.eazyhomebrunei.com.adapter.vieallsubincategoryadapter;
import app.eazyhomebrunei.com.model.catgeory;

import static app.eazyhomebrunei.com.Config.BaseURL.PATH;

public class viewallsubincategoryproducts extends AppCompatActivity implements vieallsubincategoryadapter.CartItemClickListener {
    RecyclerView recyclerView3;
    private vieallsubincategoryadapter ctadapter;

    List<catgeory> productList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_viewallsubincategoryproducts);
...
//        },5000);
    ...
    private void loadProducts() {
        final String URL_SUBCATAGORY=PATH+"ListCategoryProducts?CategoryId="+id+"&SubCategoryId="+sub_cata;
...
//
                    ...
                    ctadapter = new vieallsubincategoryadapter(getApplicationContext(), productList);
                    recyclerView3.setAdapter(ctadapter);
                    ctadapter.setOnItemClickListener(viewallsubincategoryproducts.this);
                    recyclerView3.setLayoutManager(new GridLayoutManager(viewallsubincategoryproducts.this, 2));
...
//
                    for (int i = 0; i <ar.length(); i++)
                    {
                        ...
                        catgeory product=new catgeory(wishId,pid,pname,Image,Price,OfferPrice,difference,discount,Status,Flag);
